...
import type { ListenAndChooseData } from './types';
...
export function ListenAndChoose({ data, onCorrect, onIncorrect, onComplete }: ListenAndChooseProps) {
      ...
      <div className="space-y-6 p-6">
         ...
         <div className="text-center">
            ...
            <button
               ...
               className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-primary/10 hover:bg-primary/20 transition-colors"
            >
               <Volume2 className="w-8 h-8 text-primary" />
            </button>
            {data.question && (
               <p className="mt-4 text-lg font-medium text-muted-foreground">{data.question}</p>
            )}
         </div>
