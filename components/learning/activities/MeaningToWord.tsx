...
export function MeaningToWord({ data, onCorrect, onIncorrect, onComplete }: MeaningToWordProps) {
   ...
   return (
      <div className="space-y-6 p-6">
         <div className="text-center">
            <p className="text-sm text-muted-foreground mb-2">Chọn từ vựng đúng với nghĩa</p>
